...
* The latest public release is [r1.2](https://github.com/camaraproject/ConsentManagement/releases/tag/r1.2), with the following API versions:
  * **consent-management 0.1.0**
  [[YAML]](https://github.com/camaraproject/ConsentManagement/blob/r1.2/code/API_definitions/consent-management.yaml)  [[ReDoc]](https://redocly.github.io/redoc/?url=https://raw.githubusercontent.com/camaraproject/ConsentManagement/r1.2/code/API_definitions/consent-management.yaml&nocors)  [[Swagger]](https://camaraproject.github.io/swagger-ui/?url=https://raw.githubusercontent.com/camaraproject/ConsentManagement/r1.2/code/API_definitions/consent-management.yaml)

* The latest public release is always available here: https://github.com/camaraproject/ConsentManagement/releases/latest
* Other releases of this repository are available in https://github.com/camaraproject/ConsentManagement/releases
