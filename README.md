...
Sandbox API Repository to describe, develop, document, and test the ConsentManagement Service API(s). The repository does not yet belong to a CAMARA Sub Project.
...
Sandbox API Repository to describe, develop, document, and test the ConsentManagement Service API(s) within the Sub Project [Identity And Consent Management](https://lf-camaraproject.atlassian.net/wiki/spaces/CAM/pages/14561383/Identity+Consent+Management).
...
Incubating API Repository to evolve and maintain the definitions and documentation of ConsentManagement Service API(s) within the Sub Project [Identity And Consent Management](https://lf-camaraproject.atlassian.net/wiki/spaces/CAM/pages/14561383/Identity+Consent+Management)
...
Repository for xxx of the Identity And Consent Management Working Group"

* Working Group [wiki home page](https://lf-camaraproject.atlassian.net/wiki/spaces/CAM/) 
...
* Meetings are held virtually <!-- for new, independent Sandbox API repositories request a meeting link from the LF admin team or replace the information with the existing meeting information of the Sub Project -->
  ...
  * Minutes: Access [meeting minutes](https://lf-camaraproject.atlassian.net/wiki/spaces/CAM/) !! update this link to your minutes archive page using the "Share" link and delete the task
* Mailing List
  <!-- Note: the `mailinglistname` is either already existing (for API Repositories within a Sub Projects) or will be created by the CAMARA Admin Team. -->
  * Subscribe / Unsubscribe to the mailing list <https://lists.camaraproject.org/g/sp-icm>.
